...
<meta name="description" content="Meesto is a Nonprofit Open Source cloud-based framework where you can safely and comfortably store, manipulate, and share your personal data." />
...
<meta name="og:title" content="Meesto" />
<meta name="og:description" content="Meesto is a social networking tool where you control your data and you control the site (built on Open Source and Nonprofit ideals)." />
<meta name="og:image" content="'.$baseincpat.'images/logoshr.png" / >
...
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script><script type="text/javascript">stLight.options({publisher:\'51046577-dfff-404b-be8b-bea8ca9941af\', \'st_title\': \'Meesto\', \'st_url\': \'http://www.meesto.com/\'});</script>
<script type="text/javascript">
...
if ( (isset($_SESSION['user_id'])) && (!strpos($_SERVER['PHP_SELF'], 'logout.php')) ) {
	...
	echo '<div class="headbarcontainter">
		<table cellpadding="0" cellspacing="0" width="1000px"><tr><td align="left" style="padding-left: 24px;">
			<table cellpadding="0" cellspacing="0"><tr><td align="left"><a href="'.$baseincpat.'"><img src="'.$baseincpat.'images/headerlogo.png" /></a><td align="left" style="padding-left: 18px;">
				<form method="get" action="'.$baseincpat.'signup.php"><input type="submit" value="signup"/></form>
			</td><td align="left" style="padding-left: 18px;">
				<form method="get" action="'.$baseincpat.'howyoucanhelp.php"><input type="submit" value="help us!"/></form>
			</td></tr></table>
