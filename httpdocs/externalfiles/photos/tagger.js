...
var tagger = {
	...
	starttagger: function(obj) {
		...
		var newElem7 = new Element('div', {'id': this.obj+'_loader', 'align': 'center', 'styles': {'margin-top': '4px', 'display': 'none'}, 'html': '<table cellpadding="0" cellspacing="0"><tr><td align="left" valign"center"><img src="'+baseincpat+'images/spinner.gif" /></td><td align="left" valign"center" style="padding-left: 2px;">loading...</td></tr></table>'});
	...
	addTag: function(uid){
		...
		$(this.obj+'_loader').set('styles',{'display':'block'});
		this.activetuid = 0;
		gotopage(this.obj+'_taglist', ''+baseincpat+'externalfiles/photos/grabtags.php?apid='+this.obj.substr(2)+'&action=add&uid='+uid+'&y='+$(this.obj+'_taggercont').getPosition(this.obj+'_tagcont').y+'&x='+$(this.obj+'_taggercont').getPosition(this.obj+'_tagcont').x);
