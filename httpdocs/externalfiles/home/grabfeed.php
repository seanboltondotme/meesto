...
if ($f) {
	if ($fst_fid>0) {
		$feeds = mysql_query ("(SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN feed_vis fv ON f.f_id=fv.f_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON ps.p_id=mp.p_id=f.u_id=mpc.p_id LEFT JOIN feed_vis fv2 ON f.f_id=fv2.f_id AND fv2.type='user' AND fv2.ref_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='stndrd' AND ((fv.type='pub' AND fv.sub_type='y') OR (((fv.type='strm' AND fv.sub_type=ps.stream) OR (fv.type='chan' AND fv.ref_id=mpc.mpc_id)) AND (fv2.fvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN photo_album_vis pav ON f.ref_id=pav.pa_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN photo_album_vis pav2 ON f.ref_id=pav2.pa_id AND pav2.type='user' AND pav2.ref_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvap' AND ((pav.type='pub' AND pav.sub_type='y') OR (((pav.type='strm' AND pav.sub_type=ps.stream) OR (pav.type='chan' AND pav.ref_id=mpc.mpc_id)) AND (pav2.pavis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' INNER JOIN ap_tags apt ON f.ref_id=apt.pa_id AND apt.u_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvap') 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN defvis_apt dvapt ON f.u_id=dvapt.u_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN defvis_apt dvapt2 ON f.u_id=dvapt2.u_id AND dvapt2.type='user' AND dvapt2.ref_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvapt' AND ((dvapt.type='pub' AND dvapt.sub_type='y') OR (((dvapt.type='strm' AND dvapt.sub_type=ps.stream) OR (dvapt.type='chan' AND dvapt.ref_id=mpc.mpc_id)) AND (dvapt2.aptvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_sec_vis mtsv ON f.ref_id=mtsv.mts_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_sec_vis mtsv2 ON f.ref_id=mtsv2.mts_id AND mtsv2.type='user' AND mtsv2.ref_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvmt' AND f.ref_type='mts' AND ((mtsv.type='pub' AND mtsv.sub_type='y') OR (((mtsv.type='strm' AND mtsv.sub_type=ps.stream) OR (mtsv.type='chan' AND mtsv.ref_id=mpc.mpc_id)) AND (mtsv2.mtsvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_vis mtv ON f.ref_id=mtv.mt_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_vis mtv2 ON f.ref_id=mtv2.mt_id AND mtv2.type='user' AND mtv2.ref_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvmt' AND f.ref_type='mt' AND ((mtv.type='pub' AND mtv.sub_type='y') OR (((mtv.type='strm' AND mtv.sub_type=ps.stream) OR (mtv.type='chan' AND mtv.ref_id=mpc.mpc_id)) AND (mtv2.mtvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' INNER JOIN events e ON f.ref_id=e.e_id LEFT JOIN event_owners eo ON f.ref_id=eo.e_id AND eo.u_id='$id' WHERE f.f_id<='$fst_fid' AND f.type='actvcev' AND (e.vis='pub' OR eo.eo_id IS NOT NULL)) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN feed_vis fv ON f.f_id=fv.f_id AND fv.type='strm' AND fv.sub_type='$f' WHERE f.u_id='$id' AND f.f_id<='$fst_fid') ORDER BY f_id DESC LIMIT $s, 14");
	} else {
		$feeds = mysql_query ("(SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN feed_vis fv ON f.f_id=fv.f_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON ps.p_id=mp.p_id=f.u_id=mpc.p_id LEFT JOIN feed_vis fv2 ON f.f_id=fv2.f_id AND fv2.type='user' AND fv2.ref_id='$id' WHERE f.type='stndrd' AND ((fv.type='pub' AND fv.sub_type='y') OR (((fv.type='strm' AND fv.sub_type=ps.stream) OR (fv.type='chan' AND fv.ref_id=mpc.mpc_id)) AND (fv2.fvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN photo_album_vis pav ON f.ref_id=pav.pa_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN photo_album_vis pav2 ON f.ref_id=pav2.pa_id AND pav2.type='user' AND pav2.ref_id='$id' WHERE f.type='actvap' AND ((pav.type='pub' AND pav.sub_type='y') OR (((pav.type='strm' AND pav.sub_type=ps.stream) OR (pav.type='chan' AND pav.ref_id=mpc.mpc_id)) AND (pav2.pavis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' INNER JOIN ap_tags apt ON f.ref_id=apt.pa_id AND apt.u_id='$id' WHERE f.type='actvap') 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN defvis_apt dvapt ON f.u_id=dvapt.u_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN defvis_apt dvapt2 ON f.u_id=dvapt2.u_id AND dvapt2.type='user' AND dvapt2.ref_id='$id' WHERE f.type='actvapt' AND ((dvapt.type='pub' AND dvapt.sub_type='y') OR (((dvapt.type='strm' AND dvapt.sub_type=ps.stream) OR (dvapt.type='chan' AND dvapt.ref_id=mpc.mpc_id)) AND (dvapt2.aptvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_sec_vis mtsv ON f.ref_id=mtsv.mts_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_sec_vis mtsv2 ON f.ref_id=mtsv2.mts_id AND mtsv2.type='user' AND mtsv2.ref_id='$id' WHERE f.type='actvmt' AND f.ref_type='mts' AND ((mtsv.type='pub' AND mtsv.sub_type='y') OR (((mtsv.type='strm' AND mtsv.sub_type=ps.stream) OR (mtsv.type='chan' AND mtsv.ref_id=mpc.mpc_id)) AND (mtsv2.mtsvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_vis mtv ON f.ref_id=mtv.mt_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id AND ps.stream='$f' LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_vis mtv2 ON f.ref_id=mtv2.mt_id AND mtv2.type='user' AND mtv2.ref_id='$id' WHERE f.type='actvmt' AND f.ref_type='mt' AND ((mtv.type='pub' AND mtv.sub_type='y') OR (((mtv.type='strm' AND mtv.sub_type=ps.stream) OR (mtv.type='chan' AND mtv.ref_id=mpc.mpc_id)) AND (mtv2.mtvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' AND ps.stream='$f' INNER JOIN events e ON f.ref_id=e.e_id LEFT JOIN event_owners eo ON f.ref_id=eo.e_id AND eo.u_id='$id' WHERE f.type='actvcev' AND (e.vis='pub' OR eo.eo_id IS NOT NULL)) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN feed_vis fv ON f.f_id=fv.f_id AND fv.type='strm' AND fv.sub_type='$f' WHERE f.u_id='$id') ORDER BY f_id DESC LIMIT $s, 14");
	}
} else {
	if ($fst_fid>0) {
		...
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f WHERE f.u_id='$id' AND f.f_id<='$fst_fid') ORDER BY f_id DESC LIMIT $s, 14");
	} else {
		$feeds = mysql_query ("(SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN feed_vis fv ON f.f_id=fv.f_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=mp.u_id AND ps.p_id='$id' LEFT JOIN mpc_mems mpc ON ps.p_id=mp.p_id=f.u_id=mpc.p_id LEFT JOIN feed_vis fv2 ON f.f_id=fv2.f_id AND fv2.type='user' AND fv2.ref_id='$id' WHERE f.type='stndrd' AND ((fv.type='pub' AND fv.sub_type='y') OR (((fv.type='strm' AND fv.sub_type=ps.stream) OR (fv.type='chan' AND fv.ref_id=mpc.mpc_id)) AND (fv2.fvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN photo_album_vis pav ON f.ref_id=pav.pa_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN photo_album_vis pav2 ON f.ref_id=pav2.pa_id AND pav2.type='user' AND pav2.ref_id='$id' WHERE f.type='actvap' AND ((pav.type='pub' AND pav.sub_type='y') OR (((pav.type='strm' AND pav.sub_type=ps.stream) OR (pav.type='chan' AND pav.ref_id=mpc.mpc_id)) AND (pav2.pavis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN ap_tags apt ON f.ref_id=apt.pa_id AND apt.u_id='$id' WHERE f.type='actvap') 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN defvis_apt dvapt ON f.u_id=dvapt.u_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN defvis_apt dvapt2 ON f.u_id=dvapt2.u_id AND dvapt2.type='user' AND dvapt2.ref_id='$id' WHERE f.type='actvapt' AND ((dvapt.type='pub' AND dvapt.sub_type='y') OR (((dvapt.type='strm' AND dvapt.sub_type=ps.stream) OR (dvapt.type='chan' AND dvapt.ref_id=mpc.mpc_id)) AND (dvapt2.aptvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_sec_vis mtsv ON f.ref_id=mtsv.mts_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_sec_vis mtsv2 ON f.ref_id=mtsv2.mts_id AND mtsv2.type='user' AND mtsv2.ref_id='$id' WHERE f.type='actvmt' AND f.ref_type='mts' AND ((mtsv.type='pub' AND mtsv.sub_type='y') OR (((mtsv.type='strm' AND mtsv.sub_type=ps.stream) OR (mtsv.type='chan' AND mtsv.ref_id=mpc.mpc_id)) AND (mtsv2.mtsvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN meefile_tab_vis mtv ON f.ref_id=mtv.mt_id INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN peep_streams ps ON ps.u_id=f.u_id AND ps.p_id=mp.p_id LEFT JOIN mpc_mems mpc ON mp.p_id=mpc.p_id LEFT JOIN meefile_tab_vis mtv2 ON f.ref_id=mtv2.mt_id AND mtv2.type='user' AND mtv2.ref_id='$id' WHERE f.type='actvmt' AND f.ref_type='mt' AND ((mtv.type='pub' AND mtv.sub_type='y') OR (((mtv.type='strm' AND mtv.sub_type=ps.stream) OR (mtv.type='chan' AND mtv.ref_id=mpc.mpc_id)) AND (mtv2.mtvis_id IS NULL)))) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f INNER JOIN my_peeple mp ON mp.u_id=f.u_id AND mp.p_id='$id' INNER JOIN events e ON f.ref_id=e.e_id LEFT JOIN event_owners eo ON f.ref_id=eo.e_id AND eo.u_id='$id' WHERE f.type='actvcev' AND (e.vis='pub' OR eo.eo_id IS NOT NULL)) 
		UNION DISTINCT (SELECT DISTINCT f.f_id, f.u_id, f.type, f.msg, f.ref_id, f.ref_type, DATE_FORMAT(f.time_stamp, '%b %D, %Y at %l:%i%p') AS time, f.time_stamp FROM feed f WHERE f.u_id='$id') ORDER BY f_id DESC LIMIT $s, 14");
	}
}
$f_ct = 0;
...
if ($f_ct>0) {
echo '<div align="left">
	<div align="center" class="p18" style="padding-top: 8px; padding-bottom: 4px; border-bottom: 2px solid #C5C5C5; cursor: pointer;" onclick="gotopage(this.getParent(), \''.$baseincpat.'externalfiles/home/grabfeed.php?s='.($s+14).'&fstfid='.$fst_fid; if ($f) {echo'&f='.$f;} echo'\');">show more</div>
</div>';
}
