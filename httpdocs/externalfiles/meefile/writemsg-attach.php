...
$choose = escape_data($_GET['choose']);
	...
	if ($choose=='photos') {
		...
		if ($_GET['grab']=='aps') {
			...
			if (mysql_result(mysql_query("SELECT COUNT(*) FROM album_photos WHERE pa_id='$paid' AND u_id='$id' LIMIT 1"), 0)>0) {
				...
				reporterror('profile/meefile/writemsg-attach.php', 'viewing album photos', 'don\'t own photo photo album or may not exists paid='.$paid);
				echo '</td></tr></table>';
			}
			...
			echo '<div align="left" style="margin-bottom: 12px; margin-left: 16px;">
				...
				<div align="left" id="btm_btn" class="blockbtn" style="width: 100px;" onclick="window.location.replace(\''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'\');">back to main</div>
				</td></tr></table>
			</div>
			<div id="pacatalog" style="overflow-y: scroll; overflow-x: hidden; height: 180px; width: 560px;">
				<table cellpadding="0" cellspacing="0">';
					...
					while ($album = @mysql_fetch_array ($albums, MYSQL_ASSOC)) {
						...
						echo '<tr><td align="left" style="border-bottom: 1px solid #ECECEC; padding-top: 12px; padding-bottom: 6px; cursor: pointer;" onclick="gotopage(\'pacatalog\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=photos&grab=aps&paid='.$paid; echo'\', \'182\');">
			...
			reporterror('meefile/writemsg-attach.php', 'loading swfuploader', 'unable to load, displayed error msg');
			...
			<div align="center" style="margin-top: 32px; margin-bottom: 32px;">
					<div align="center"><table cellpadding="0" cellspacing="0"><tr><td align="left" valign="center" style="font-size: 13px; ">
						...
						<div align="center" id="sbmtbtns">
							<div align="center">
								<input type="button" id="submit" value="attach" name="attach" onclick="$(\'sbmtbtns\').set(\'styles\',{\'display\':\'none\'});$(\'url_cont\').fade(\'hide\');parent.$(\'pbox-loader\').set(\'styles\',{\'display\':\'block\'});$(\'loader\').set(\'styles\',{\'display\':\'block\'});parent.$(\'convomsgwrite'.$uid.'\').contentWindow.getlinkdata.get($(\'url\').value, \'convomsgwrite'.$uid.'\');""/>
							</div>
						</div>
					</td></tr></table></div>
		...
		if ($method=='upld') {
				...
				<div id="pacatalog" style="overflow-y: scroll; overflow-x: hidden; height: 180px; width: 560px;">
					<table cellpadding="0" cellspacing="0">';
						...
						while ($atchmnt = @mysql_fetch_array ($atchmnts, MYSQL_ASSOC)) {
							$uaid = $atchmnt['ua_id'];
							echo '<tr><td align="left" style="border-bottom: 1px solid #ECECEC; padding-top: 12px; padding-bottom: 6px; cursor: pointer;" onclick="parent.$(\'pbox-loader\').set(\'styles\',{\'display\':\'block\'});parent.$(\'convomsgwrite'.$uid.'\').contentWindow.attachments.upload(\''.$baseincpat.substr($atchmnt['url'], 0, strrpos($atchmnt['url'], '.')).'tn'.substr($atchmnt['url'], strrpos($atchmnt['url'], '.')).'\', \''.$uaid.'\');">
				...
				<div id="pacatalog" style="overflow-y: scroll; overflow-x: hidden; height: 180px; width: 560px;">
					<table cellpadding="0" cellspacing="0">';
						...
						while ($link = @mysql_fetch_array ($links, MYSQL_ASSOC)) {
							$uaid = $link['ua_id'];
							echo '<tr><td align="left" style="border-bottom: 1px solid #ECECEC; padding-top: 12px; padding-bottom: 6px; cursor: pointer;" onclick="parent.$(\'pbox-loader\').set(\'styles\',{\'display\':\'block\'});parent.$(\'convomsgwrite'.$uid.'\').contentWindow.attachments.lnk(\''.$link['type'].'\', \''.$link['host'].'\', \''.$baseincpat.$link['tn_url'].'\', \''.$link['title'].'\', \''.$link['description'].'\', \''.$uaid.'\');">
			...
			<table cellpadding="0" cellspacing="0"><tr><td align="left" valign="top" style="padding-right: 4px;">
				<div class="blockbtn" style="width: 210px; height: 96px;" onclick="gotopage(\'mainarea\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=prev&method=upld\');">
				...
				<div class="blockbtn" style="width: 210px; height: 96px;" onclick="gotopage(\'mainarea\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=prev&method=link\');">
	...
	reporterror('profile/meefile/writemsg-attach.php', 'attaching to message - making selection', 'choose is not set');
	echo '</td></tr></table>';
	}
...
<script type="text/javascript">
		...
		window.onload = function () {
			swfu = new SWFUpload({
				// Backend Settings
				upload_url: "writemsg-attach-uploadhandler.php",
				post_params: {"uid": "'.$uid.'"},
...
echo '<div align="left" class="p24" style="width: 460px; border-bottom: 1px solid #C5C5C5;">Attach To Message</div>
<div align="left" class="subtext" style="padding-left: 20px; padding-top: 2px; padding-bottom: 18px;">Use this to attach something to your message.</div>
...
if ($_GET['action']=='upload') {
	...
	echo '<div align="center">
			<table cellpadding="0" cellspacing="0"><tr><td align="left" valign="top" style="padding-right: 4px;">
				<div class="blockbtn" style="width: 132px; height: 96px;" onclick="gotopage(\'mainarea\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=photos\');">
				...
				<div class="blockbtn" style="width: 132px; height: 96px;" onclick="window.location.replace(\''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&action=upload\');">
				...
				<div class="blockbtn" style="width: 132px; height: 96px;" onclick="gotopage(\'mainarea\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=link\');">
				...
				<div class="blockbtn" style="width: 132px; height: 96px;" onclick="gotopage(\'mainarea\', \''.$baseincpat.'externalfiles/meefile/writemsg-attach.php?uid='.$uid.'&choose=prev\');">
