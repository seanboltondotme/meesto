...
echo '<div align="left" class="p24" style="width: 460px; border-bottom: 1px solid #C5C5C5;">Edit Default Feed Post Visibility</div>
<div align="left" class="subtext" style="padding-left: 20px; padding-top: 2px; padding-bottom: 22px;">Use this to customize the default visibility setting applied to new feed posts.</div>';
...
if (isset($_POST['save'])) {
	...
	if (empty($errors)) {
		...
		reporterror('settings/editdeffeedpostvis.php', 'setting def vis', $errors);
		echo '</td></tr></table>
		<script type="text/javascript">
	...
	echo '<form action="'.$baseincpat.'externalfiles/settings/editdeffeedpostvis.php" method="post">
