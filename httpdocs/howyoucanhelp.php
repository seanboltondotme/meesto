...
echo '<div align="left" style="margin-left: 54px;">
	...
	<div align="left" valign="bottom" class="p24" style="width: 900px; border-bottom: 1px solid #C5C5C5; margin-top: 24px; padding-left: 8px; height: 29px;">
		<ul class="mftabul">
			<li class="mftabli'; if($t==''){echo'On';} echo'" style="padding-right: 24px;"><div class="mftabliico"></div><a href="'.$baseincpat.'howyoucanhelp.php?">general</a></li>
			<li class="mftabli" style="padding-right: 24px;"><div class="mftabliico"></div><a href="'.$baseincpat.'donate.php?">donate/support</a></li>
			<li class="mftabli'; if($t=='development'){echo'On';} echo'" style="padding-right: 24px;"><div class="mftabliico"></div><a href="'.$baseincpat.'howyoucanhelp.php?t=development">open source development</a></li>
			<li class="mftabli'; if($t=='corporate'){echo'On';} echo'"><div class="mftabliico"></div><a href="'.$baseincpat.'jobs.php?">corporate positions</a></li>
		</ul>
	</div>
</div>';
...
echo '<div align="left" style="padding-top: 24px; margin-left: 68px;">';
	...
	if ($t=='development') {
		include ('externalfiles/hych/development.php');
	} else {
		include ('externalfiles/hych/general.php');
	}
